...
* 不设置  **android:configChanges** ，切屏会销毁当前 Activity，重新加载各个生命周期，切横屏时会执行一次，**切竖屏时会执行两次(目前在所有Android版本上都未发现)**。
...
![image-20221106222959320](./assets/android_handler_message.png)
...
![image-20221106223041432](./assets/android_service_lifecycle.png)
...
![image-20221106223156929](./assets/android_apk_sign.png)
...
![image-20221106223257140](./assets/android_binder.png)
