...
* 形式: 字符常量是单引号（''）引起的一个字符; 字符**串**常量是双引号（" "）引起的 0 个或若干个字符.
...
![image-20221105211918970](./assets/java_jre.png)

#### 64 JVM 内存区域

![image-20221105212029941](./assets/java_jvm.png)
...
![image-20221105212136665](./assets/java_gcpng.png)
...
![image-20221105212231175](./assets/java_collections.png)
